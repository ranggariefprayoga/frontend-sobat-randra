...
export function UpdateFreeProductTryOutModal({ initialData }: { initialData?: updateTryOutResponse }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button>Edit Try Out Gratis</Button>
      </DialogTrigger>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Edit Try Out Gratis</DialogTitle>
...
export default UpdateFreeProductTryOutModal;
