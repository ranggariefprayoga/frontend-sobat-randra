...
import { useCreateProductPromo } from "@/lib/api/productPromo.api";

export function BuatPromoModal() {
  ...
  const buatProdukPromo = useCreateProductPromo();
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Buat Promo</DialogTitle>
          <DialogDescription>Isi form dibawah ini untuk membuat Produk Promo.</DialogDescription>
        ...
        <div className="space-y-4">
          ...
          <Button onClick={handleSubmit} disabled={buatProdukPromo.isPending}>
            {buatProdukPromo.isPending ? "Membuat..." : "Simpan Produk"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
